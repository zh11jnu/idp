...
class Video():
    def __init__(self, capture):
        ...
        self.capture.getData(self.capture.interval)

    def captureFrame(self):
        """
        capture frame and return captured frame
        """
        readFrame = self.capture.read()
...
class Gui(QtGui.QMainWindow):
    def __init__(self, parent=None):
        ...
        self.video = Video(camera_client.webCamConnect())
        ...
        self.capturedFrame = self.video.capture.read()
    ...
    def addText(self):
        ...
        cv2.putText(imText, text, (20, 450),
