...
class webCamConnect:
    ...
    def __init__(self, resolution=[640, 480], remoteAddress=("192.168.0.106",
    ...
    def read(self):
        while self.img_pipe.empty():
            pass
        return self.img_pipe.get()
        ...
        while(1):
            ...
            if bufSize:
                try:
                    ...
                    cv2.imshow('socket thread', self.image)
                    self.img_pipe.put(self.image)
