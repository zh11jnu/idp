...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.picComboBox = QtGui.QComboBox(self.centralwidget)
        self.picComboBox.setGeometry(QtCore.QRect(400, 300, 100, 23))
        self.picComboBox.setObjectName(_fromUtf8("picComboBox"))
        self.picComboBox.insertItem(0, "640x480")
        self.picComboBox.insertItem(1, "3280x2464")



        self.btnSave = QtGui.QPushButton(self.centralwidget)
        self.btnSave.setGeometry(QtCore.QRect(500, 300, 75, 23))
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Monitering", None))
        ...
        # self.videoFrame_2.setText(_translate(
        #     "MainWindow", "Video Frame", None))
